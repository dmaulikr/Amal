...
@interface AmalNewFrequencyController ()
-(void)configureView;
@end

@implementation AmalNewFrequencyController
...
-(void)configureView
{
    // Highlight current frequency and put a checkmark
...
-(void)setCurrentFrequency:(NSString *)currentFrequency
{
    if(_currentFrequency != currentFrequency)
    {
...
{
    [[self delegate] amalNewFrequencyControllerDidFinish:self frequency:self.currentFrequency];
}

-(IBAction)cancel:(id)sender
{
    [[self delegate] amalNewFrequencyControllerDidCancel:self];
}
